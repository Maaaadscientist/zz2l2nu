    ...
    for channel in ['ee','mumu']:
      for label in closurelabels:
        ...
        if 'Data' in label:
          ...
          if 'Num_pre_'+sidebandtype+'_'+Btagveto+'_'+label+'_'+channel+'_METcut'+str(50+i*5) == 'Num_pre_allSB_btag_outputNRB_Data_ee_METcut80':
...
def GetHisto (filename, histoname) :
  ...
  if 'NRBctrl' in histoname:
    ...
    h = rt.TH1F()
  Nevent = rt.TH1F()
  file = rt.TFile.Open("firstTest_NRB/MERGED/"+filename+'.root')
...
print 'Num_upSB_bveto_allMC_ee_METcut80', results_2D['Num_upSB_bveto_allMC_ee_METcut80']
print 'Num_upSB_bveto_   WW_ee_METcut80', results_2D['Num_upSB_bveto_WW_ee_METcut80']
#print results_2D['Num_allSB_allMC_emu_METcut80'],'-',results_2D['Errsquare_allSB_low_allMC_emu_METcut80'],'+',results_2D['Errsquare_allSB_up_allMC_emu_METcut80'],'\n',results_2D['Num_upSB_allMC_emu_METcut80'] ,'-',results_2D['Errsquare_upSB_low_allMC_emu_METcut80'] ,'+',results_2D['Errsquare_upSB_up_allMC_emu_METcut80'],'\n'
...
print 0.5*math.sqrt(results_2D['Num_in_btag_outputNRB_Data_ee_METcut80']/results_2D['Num_in_btag_outputNRB_Data_mumu_METcut80']),0.5*math.sqrt(results_2D['Num_in_btag_outputNRB_Data_mumu_METcut80']/results_2D['Num_in_btag_outputNRB_Data_ee_METcut80'])
...
catalogfile.write("Top & $"+"%.1f" %results_2D['Num_in_bveto_Top_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_Top_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_Top_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_allSB_btag_Top_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_up_Top_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_low_Top_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_allSB_btag_Top_ee_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_up_Top_ee_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_low_Top_ee_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_allSB_btag_Top_ee_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_allSB_btag_Top_ee_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_allSB_btag_Top_ee_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_allSB_btag_Top_ee_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_allSB_btag_Top_ee_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_allSB_btag_Top_ee_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_exp_allSB_bveto_Top_ee_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_allSB_bveto_Top_ee_METcut125']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_allSB_bveto_Top_ee_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_allSB_btag_Top_ee_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_allSB_btag_Top_ee_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_allSB_btag_Top_ee_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("Top+WW & $"+"%.1f" %results_2D['Num_in_bveto_WW_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_WW_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_WW_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_allSB_btag_WW_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_up_WW_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_low_WW_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_allSB_btag_WW_ee_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_up_WW_ee_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_low_WW_ee_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_allSB_btag_WW_ee_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_allSB_btag_WW_ee_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_allSB_btag_WW_ee_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_allSB_btag_WW_ee_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_allSB_btag_WW_ee_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_allSB_btag_WW_ee_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_exp_allSB_bveto_WW_ee_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_allSB_bveto_WW_ee_METcut125']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_allSB_bveto_WW_ee_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_allSB_btag_WW_ee_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_allSB_btag_WW_ee_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_allSB_btag_WW_ee_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("allMC & $"+"%.1f" %results_2D['Num_in_bveto_allMC_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_allMC_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_allMC_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_allSB_btag_allMC_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_up_allMC_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_low_allMC_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_allSB_btag_allMC_ee_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_up_allMC_ee_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_low_allMC_ee_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_allSB_btag_allMC_ee_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_allSB_btag_allMC_ee_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_allSB_btag_allMC_ee_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_allSB_btag_allMC_ee_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_allSB_btag_allMC_ee_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_allSB_btag_allMC_ee_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_exp_allSB_bveto_allMC_ee_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_allSB_bveto_allMC_ee_METcut125']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_allSB_bveto_allMC_ee_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_allSB_btag_allMC_ee_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_allSB_btag_allMC_ee_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_allSB_btag_allMC_ee_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("\\hline $\\mu\\mu $  & $N_{e\\mu}^{in}$ & $N_{e\\mu}^{out}$  & $N_{\\mu\\mu}^{out}$&  $   \\alpha   $ & $N_{\\mu\\mu}^{SR, est}$& $N_{\\mu\\mu}^{SR, exp}$ & $f_{est/exp}$ \\\\  \\hline \n")
catalogfile.write("Top & $"+"%.1f" %results_2D['Num_in_bveto_Top_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_Top_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_Top_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_allSB_btag_Top_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_up_Top_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_low_Top_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_allSB_btag_Top_mumu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_up_Top_mumu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_low_Top_mumu_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_allSB_btag_Top_mumu_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_allSB_btag_Top_mumu_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_allSB_btag_Top_mumu_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_allSB_btag_Top_mumu_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_allSB_btag_Top_mumu_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_allSB_btag_Top_mumu_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_exp_allSB_bveto_Top_mumu_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_allSB_bveto_Top_mumu_METcut125']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_allSB_bveto_Top_mumu_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_allSB_btag_Top_mumu_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_allSB_btag_Top_mumu_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_allSB_btag_Top_mumu_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("Top+WW & $"+"%.1f" %results_2D['Num_in_bveto_WW_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_WW_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_WW_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_allSB_btag_WW_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_up_WW_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_low_WW_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_allSB_btag_WW_mumu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_up_WW_mumu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_low_WW_mumu_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_allSB_btag_WW_mumu_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_allSB_btag_WW_mumu_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_allSB_btag_WW_mumu_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_allSB_btag_WW_mumu_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_allSB_btag_WW_mumu_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_allSB_btag_WW_mumu_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_exp_allSB_bveto_WW_mumu_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_allSB_bveto_WW_mumu_METcut125']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_allSB_bveto_WW_mumu_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_allSB_btag_WW_mumu_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_allSB_btag_WW_mumu_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_allSB_btag_WW_mumu_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("allMC & $"+"%.1f" %results_2D['Num_in_bveto_allMC_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_allMC_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_allMC_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_allSB_btag_allMC_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_up_allMC_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_low_allMC_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_allSB_btag_allMC_mumu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_up_allMC_mumu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_low_allMC_mumu_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_allSB_btag_allMC_mumu_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_allSB_btag_allMC_mumu_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_allSB_btag_allMC_mumu_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_allSB_btag_allMC_mumu_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_allSB_btag_allMC_mumu_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_allSB_btag_allMC_mumu_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_exp_allSB_bveto_allMC_mumu_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_allSB_bveto_allMC_mumu_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_allSB_bveto_allMC_mumu_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_allSB_btag_allMC_mumu_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_allSB_btag_allMC_mumu_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_allSB_btag_allMC_mumu_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("\\hline \\hline\n")
catalogfile.write("\\multicolumn{8}{c}{b-vetoed sample} \\\\ \\hline \n")
catalogfile.write("\\hline $ee$  & $N_{e\\mu}^{in}$ & $N_{e\\mu}^{out}$  & $N_{ee}^{out}$&  $   \\alpha   $ & $N_{ee}^{SR, est}$& $N_{ee}^{SR, exp}$ & $f_{est/exp}$ \\\\  \\hline \n")
catalogfile.write("Top & $"+"%.1f" %results_2D['Num_in_bveto_Top_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_Top_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_Top_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_allSB_bveto_Top_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_bveto_up_Top_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_bveto_low_Top_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_allSB_bveto_Top_ee_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_bveto_up_Top_ee_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_bveto_low_Top_ee_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_allSB_bveto_Top_ee_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_allSB_bveto_Top_ee_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_allSB_bveto_Top_ee_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_allSB_bveto_Top_ee_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_allSB_bveto_Top_ee_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_allSB_bveto_Top_ee_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_exp_allSB_bveto_Top_ee_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_allSB_bveto_Top_ee_METcut125']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_allSB_bveto_Top_ee_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_allSB_bveto_Top_ee_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_allSB_bveto_Top_ee_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_allSB_bveto_Top_ee_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("Top+WW & $"+"%.1f" %results_2D['Num_in_bveto_WW_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_WW_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_WW_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_allSB_bveto_WW_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_bveto_up_WW_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_bveto_low_WW_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_allSB_bveto_WW_ee_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_bveto_up_WW_ee_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_bveto_low_WW_ee_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_allSB_bveto_WW_ee_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_allSB_bveto_WW_ee_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_allSB_bveto_WW_ee_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_allSB_bveto_WW_ee_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_allSB_bveto_WW_ee_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_allSB_bveto_WW_ee_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_exp_allSB_bveto_WW_ee_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_allSB_bveto_WW_ee_METcut125']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_allSB_bveto_WW_ee_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_allSB_bveto_WW_ee_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_allSB_bveto_WW_ee_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_allSB_bveto_WW_ee_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("allMC & $"+"%.1f" %results_2D['Num_in_bveto_allMC_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_allMC_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_allMC_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_allSB_bveto_allMC_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_bveto_up_allMC_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_bveto_low_allMC_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_allSB_bveto_allMC_ee_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_bveto_up_allMC_ee_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_bveto_low_allMC_ee_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_allSB_bveto_allMC_ee_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_allSB_bveto_allMC_ee_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_allSB_bveto_allMC_ee_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_allSB_bveto_allMC_ee_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_allSB_bveto_allMC_ee_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_allSB_bveto_allMC_ee_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_exp_allSB_bveto_allMC_ee_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_allSB_bveto_allMC_ee_METcut125']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_allSB_bveto_allMC_ee_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_allSB_bveto_allMC_ee_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_allSB_bveto_allMC_ee_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_allSB_bveto_allMC_ee_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("\\hline $\\mu\\mu $  & $N_{e\\mu}^{in}$ & $N_{e\\mu}^{out}$  & $N_{\\mu\\mu}^{out}$&  $   \\alpha   $ & $N_{\\mu\\mu}^{SR, est}$& $N_{\\mu\\mu}^{SR, exp}$ & $f_{est/exp}$ \\\\  \\hline \n")
catalogfile.write("Top & $"+"%.1f" %results_2D['Num_in_bveto_Top_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_Top_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_Top_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_allSB_bveto_Top_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_bveto_up_Top_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_bveto_low_Top_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_allSB_bveto_Top_mumu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_bveto_up_Top_mumu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_bveto_low_Top_mumu_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_allSB_bveto_Top_mumu_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_allSB_bveto_Top_mumu_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_allSB_bveto_Top_mumu_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_allSB_bveto_Top_mumu_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_allSB_bveto_Top_mumu_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_allSB_bveto_Top_mumu_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_exp_allSB_bveto_Top_mumu_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_allSB_bveto_Top_mumu_METcut125']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_allSB_bveto_Top_mumu_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_allSB_bveto_Top_mumu_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_allSB_bveto_Top_mumu_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_allSB_bveto_Top_mumu_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("Top+WW & $"+"%.1f" %results_2D['Num_in_bveto_WW_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_WW_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_WW_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_allSB_bveto_WW_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_bveto_up_WW_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_bveto_low_WW_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_allSB_bveto_WW_mumu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_bveto_up_WW_mumu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_bveto_low_WW_mumu_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_allSB_bveto_WW_mumu_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_allSB_bveto_WW_mumu_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_allSB_bveto_WW_mumu_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_allSB_bveto_WW_mumu_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_allSB_bveto_WW_mumu_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_allSB_bveto_WW_mumu_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_exp_allSB_bveto_WW_mumu_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_allSB_bveto_WW_mumu_METcut125']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_allSB_bveto_WW_mumu_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_allSB_bveto_WW_mumu_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_allSB_bveto_WW_mumu_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_allSB_bveto_WW_mumu_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("allMC & $"+"%.1f" %results_2D['Num_in_bveto_allMC_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_allMC_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_allMC_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_allSB_bveto_allMC_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_bveto_up_allMC_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_bveto_low_allMC_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_allSB_bveto_allMC_mumu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_bveto_up_allMC_mumu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_bveto_low_allMC_mumu_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_allSB_bveto_allMC_mumu_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_allSB_bveto_allMC_mumu_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_allSB_bveto_allMC_mumu_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_allSB_bveto_allMC_mumu_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_allSB_bveto_allMC_mumu_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_allSB_bveto_allMC_mumu_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_exp_allSB_bveto_allMC_mumu_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_allSB_bveto_allMC_mumu_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_allSB_bveto_allMC_mumu_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_allSB_bveto_allMC_mumu_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_allSB_bveto_allMC_mumu_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_allSB_bveto_allMC_mumu_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("\\hline \\hline\n")
...
catalogfile.write("\\multicolumn{8}{c}{b-tagged sample} \\\\ \\hline \n")
catalogfile.write("\\hline $ee$  & $N_{e\\mu}^{in}$ & $N_{e\\mu}^{out}$  & $N_{ee}^{out}$&  $   \\alpha   $ & $N_{ee}^{SR, est}$& $N_{ee}^{SR, exp}$ & $f_{est/exp}$ \\\\  \\hline \n")
catalogfile.write("Top & $"+"%.1f" %results_2D['Num_in_bveto_Top_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_Top_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_Top_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_upSB_btag_Top_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_btag_up_Top_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_btag_low_Top_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_upSB_btag_Top_ee_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_btag_up_Top_ee_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_btag_low_Top_ee_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_upSB_btag_Top_ee_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_upSB_btag_Top_ee_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_upSB_btag_Top_ee_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_upSB_btag_Top_ee_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_upSB_btag_Top_ee_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_upSB_btag_Top_ee_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_in_bveto_Top_ee_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_upSB_bveto_Top_ee_METcut125']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_upSB_bveto_Top_ee_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_upSB_btag_Top_ee_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_upSB_btag_Top_ee_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_upSB_btag_Top_ee_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("Top+WW & $"+"%.1f" %results_2D['Num_in_bveto_WW_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_WW_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_WW_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_upSB_btag_WW_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_btag_up_WW_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_btag_low_WW_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_upSB_btag_WW_ee_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_btag_up_WW_ee_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_btag_low_WW_ee_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_upSB_btag_WW_ee_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_upSB_btag_WW_ee_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_upSB_btag_WW_ee_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_upSB_btag_WW_ee_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_upSB_btag_WW_ee_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_upSB_btag_WW_ee_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_in_bveto_WW_ee_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_upSB_bveto_WW_ee_METcut125']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_upSB_bveto_WW_ee_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_upSB_btag_WW_ee_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_upSB_btag_WW_ee_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_upSB_btag_WW_ee_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("allMC & $"+"%.1f" %results_2D['Num_in_bveto_allMC_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_allMC_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_allMC_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_upSB_btag_allMC_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_btag_up_allMC_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_btag_low_allMC_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_upSB_btag_allMC_ee_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_btag_up_allMC_ee_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_btag_low_allMC_ee_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_upSB_btag_allMC_ee_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_upSB_btag_allMC_ee_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_upSB_btag_allMC_ee_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_upSB_btag_allMC_ee_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_upSB_btag_allMC_ee_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_upSB_btag_allMC_ee_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_in_bveto_allMC_ee_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_upSB_bveto_allMC_ee_METcut125']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_upSB_bveto_allMC_ee_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_upSB_btag_allMC_ee_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_upSB_btag_allMC_ee_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_upSB_btag_allMC_ee_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("\\hline $\\mu\\mu $  & $N_{e\\mu}^{in}$ & $N_{e\\mu}^{out}$  & $N_{\\mu\\mu}^{out}$&  $   \\alpha   $ & $N_{\\mu\\mu}^{SR, est}$& $N_{\\mu\\mu}^{SR, exp}$ & $f_{est/exp}$ \\\\  \\hline \n")
catalogfile.write("Top & $"+"%.1f" %results_2D['Num_in_bveto_Top_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_Top_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_Top_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_upSB_btag_Top_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_btag_up_Top_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_btag_low_Top_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_upSB_btag_Top_mumu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_btag_up_Top_mumu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_btag_low_Top_mumu_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_upSB_btag_Top_mumu_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_upSB_btag_Top_mumu_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_upSB_btag_Top_mumu_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_upSB_btag_Top_mumu_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_upSB_btag_Top_mumu_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_upSB_btag_Top_mumu_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_exp_upSB_bveto_Top_mumu_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_upSB_bveto_Top_mumu_METcut125']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_upSB_bveto_Top_mumu_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_upSB_btag_Top_mumu_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_upSB_btag_Top_mumu_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_upSB_btag_Top_mumu_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("Top+WW & $"+"%.1f" %results_2D['Num_in_bveto_WW_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_WW_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_WW_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_upSB_btag_WW_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_btag_up_WW_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_btag_low_WW_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_upSB_btag_WW_mumu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_btag_up_WW_mumu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_btag_low_WW_mumu_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_upSB_btag_WW_mumu_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_upSB_btag_WW_mumu_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_upSB_btag_WW_mumu_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_upSB_btag_WW_mumu_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_upSB_btag_WW_mumu_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_upSB_btag_WW_mumu_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_exp_upSB_bveto_WW_mumu_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_upSB_bveto_WW_mumu_METcut125']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_upSB_bveto_WW_mumu_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_upSB_btag_WW_mumu_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_upSB_btag_WW_mumu_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_upSB_btag_WW_mumu_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("allMC & $"+"%.1f" %results_2D['Num_in_bveto_allMC_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_allMC_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_allMC_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_upSB_btag_allMC_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_btag_up_allMC_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_btag_low_allMC_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_upSB_btag_allMC_mumu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_btag_up_allMC_mumu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_btag_low_allMC_mumu_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_upSB_btag_allMC_mumu_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_upSB_btag_allMC_mumu_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_upSB_btag_allMC_mumu_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_upSB_btag_allMC_mumu_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_upSB_btag_allMC_mumu_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_upSB_btag_allMC_mumu_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_exp_upSB_bveto_allMC_mumu_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_upSB_bveto_allMC_mumu_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_upSB_bveto_allMC_mumu_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_upSB_btag_allMC_mumu_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_upSB_btag_allMC_mumu_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_upSB_btag_allMC_mumu_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("\\hline \n")
catalogfile.write("\\multicolumn{8}{c}{b-vetoed sample} \\\\ \\hline \n")
catalogfile.write("\\hline $ee$  & $N_{e\\mu}^{in}$ & $N_{e\\mu}^{out}$  & $N_{ee}^{out}$&  $   \\alpha   $ & $N_{ee}^{SR, est}$& $N_{ee}^{SR, exp}$ & $f_{est/exp}$ \\\\  \\hline \n")
catalogfile.write("Top & $"+"%.1f" %results_2D['Num_in_bveto_Top_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_Top_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_Top_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_upSB_bveto_Top_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_bveto_up_Top_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_bveto_low_Top_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_upSB_bveto_Top_ee_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_bveto_up_Top_ee_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_bveto_low_Top_ee_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_upSB_bveto_Top_ee_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_upSB_bveto_Top_ee_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_upSB_bveto_Top_ee_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_upSB_bveto_Top_ee_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_upSB_bveto_Top_ee_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_upSB_bveto_Top_ee_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_exp_upSB_bveto_Top_ee_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_upSB_bveto_Top_ee_METcut125']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_upSB_bveto_Top_ee_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_upSB_bveto_Top_ee_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_upSB_bveto_Top_ee_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_upSB_bveto_Top_ee_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("Top+WW & $"+"%.1f" %results_2D['Num_in_bveto_WW_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_WW_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_WW_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_upSB_bveto_WW_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_bveto_up_WW_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_bveto_low_WW_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_upSB_bveto_WW_ee_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_bveto_up_WW_ee_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_bveto_low_WW_ee_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_upSB_bveto_WW_ee_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_upSB_bveto_WW_ee_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_upSB_bveto_WW_ee_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_upSB_bveto_WW_ee_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_upSB_bveto_WW_ee_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_upSB_bveto_WW_ee_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_exp_upSB_bveto_WW_ee_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_upSB_bveto_WW_ee_METcut125']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_upSB_bveto_WW_ee_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_upSB_bveto_WW_ee_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_upSB_bveto_WW_ee_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_upSB_bveto_WW_ee_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("allMC & $"+"%.1f" %results_2D['Num_in_bveto_allMC_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_allMC_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_allMC_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_upSB_bveto_allMC_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_bveto_up_allMC_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_bveto_low_allMC_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_upSB_bveto_allMC_ee_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_bveto_up_allMC_ee_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_bveto_low_allMC_ee_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_upSB_bveto_allMC_ee_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_upSB_bveto_allMC_ee_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_upSB_bveto_allMC_ee_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_upSB_bveto_allMC_ee_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_upSB_bveto_allMC_ee_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_upSB_bveto_allMC_ee_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_exp_upSB_bveto_allMC_ee_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_upSB_bveto_allMC_ee_METcut125']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_upSB_bveto_allMC_ee_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_upSB_bveto_allMC_ee_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_upSB_bveto_allMC_ee_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_upSB_bveto_allMC_ee_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("\\hline $\\mu\\mu $  & $N_{e\\mu}^{in}$ & $N_{e\\mu}^{out}$  & $N_{\\mu\\mu}^{out}$&  $   \\alpha   $ & $N_{\\mu\\mu}^{SR, est}$& $N_{\\mu\\mu}^{SR, exp}$ & $f_{est/exp}$ \\\\  \\hline \n")
catalogfile.write("Top & $"+"%.1f" %results_2D['Num_in_bveto_Top_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_Top_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_Top_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_upSB_bveto_Top_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_bveto_up_Top_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_bveto_low_Top_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_upSB_bveto_Top_mumu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_bveto_up_Top_mumu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_bveto_low_Top_mumu_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_upSB_bveto_Top_mumu_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_upSB_bveto_Top_mumu_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_upSB_bveto_Top_mumu_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_upSB_bveto_Top_mumu_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_upSB_bveto_Top_mumu_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_upSB_bveto_Top_mumu_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_exp_upSB_bveto_Top_mumu_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_upSB_bveto_Top_mumu_METcut125']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_upSB_bveto_Top_mumu_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_upSB_bveto_Top_mumu_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_upSB_bveto_Top_mumu_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_upSB_bveto_Top_mumu_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("Top+WW & $"+"%.1f" %results_2D['Num_in_bveto_WW_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_WW_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_WW_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_upSB_bveto_WW_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_bveto_up_WW_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_bveto_low_WW_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_upSB_bveto_WW_mumu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_bveto_up_WW_mumu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_bveto_low_WW_mumu_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_upSB_bveto_WW_mumu_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_upSB_bveto_WW_mumu_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_upSB_bveto_WW_mumu_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_upSB_bveto_WW_mumu_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_upSB_bveto_WW_mumu_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_upSB_bveto_WW_mumu_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_exp_upSB_bveto_WW_mumu_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_upSB_bveto_WW_mumu_METcut125']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_upSB_bveto_WW_mumu_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_upSB_bveto_WW_mumu_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_upSB_bveto_WW_mumu_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_upSB_bveto_WW_mumu_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("allMC & $"+"%.1f" %results_2D['Num_in_bveto_allMC_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_allMC_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_allMC_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_upSB_bveto_allMC_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_bveto_up_allMC_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_bveto_low_allMC_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_upSB_bveto_allMC_mumu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_bveto_up_allMC_mumu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_upSB_bveto_low_allMC_mumu_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_upSB_bveto_allMC_mumu_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_upSB_bveto_allMC_mumu_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_upSB_bveto_allMC_mumu_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_upSB_bveto_allMC_mumu_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_upSB_bveto_allMC_mumu_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_upSB_bveto_allMC_mumu_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_exp_upSB_bveto_allMC_mumu_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_upSB_bveto_allMC_mumu_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_upSB_bveto_allMC_mumu_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_upSB_bveto_allMC_mumu_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_upSB_bveto_allMC_mumu_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_upSB_bveto_allMC_mumu_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("\\hline \n")
catalogfile.write("\\end{tabular} \n")
catalogfile.write("\\newpage \n")
catalogfile.write("\n")
...
catalogfile.write("\\multirow{2}{0.5in}{$ee$} &Data & "+"$"+"%.3f" %results_2D['alpha_upSB_btag_outputNRB_Data_ee_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_upSB_btag_outputNRB_Data_ee_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_upSB_btag_outputNRB_Data_ee_METcut80']+"}$"+" & "+"$"+"%.3f" %results_2D['alpha_allSB_btag_outputNRB_Data_ee_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_allSB_btag_outputNRB_Data_ee_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_allSB_btag_outputNRB_Data_ee_METcut80']+"}$"+" \\\\ & MC & "+"$"+"%.3f" %results_2D['alpha_upSB_btag_allMC_ee_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_upSB_btag_allMC_ee_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_upSB_btag_allMC_ee_METcut80']+"}$"+" & "+"$"+"%.3f" %results_2D['alpha_allSB_btag_allMC_ee_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_allSB_btag_allMC_ee_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_allSB_btag_allMC_ee_METcut80']+"}$"+"  \\\\ \\hline \n")
catalogfile.write("\\multirow{2}{0.5in}{$\\mu\\mu$} &Data & "+"$"+"%.3f" %results_2D['alpha_upSB_btag_outputNRB_Data_mumu_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_upSB_btag_outputNRB_Data_mumu_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_upSB_btag_outputNRB_Data_mumu_METcut80']+"}$"+" & "+"$"+"%.3f" %results_2D['alpha_allSB_btag_outputNRB_Data_mumu_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_allSB_btag_outputNRB_Data_mumu_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_allSB_btag_outputNRB_Data_mumu_METcut80']+"}$"+" \\\\ & MC & "+"$"+"%.3f" %results_2D['alpha_upSB_btag_allMC_mumu_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_upSB_btag_allMC_mumu_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_upSB_btag_allMC_mumu_METcut80']+"}$"+" & "+"$"+"%.3f" %results_2D['alpha_allSB_btag_allMC_mumu_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_allSB_btag_allMC_mumu_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_allSB_btag_allMC_mumu_METcut80']+"}$"+"  \\\\ \\hline \n")
catalogfile.write("\\hline  \n")
catalogfile.write("\\end{tabular}  \n")
catalogfile.write("\\newpage \n")
catalogfile.write("\n")
...
catalogfile.write("\\hline NRB & $"+"%.1f" %results_2D['Num_in_bveto_outputNRB_Data_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_outputNRB_Data_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_outputNRB_Data_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_allSB_btag_outputNRB_Data_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_up_outputNRB_Data_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_low_outputNRB_Data_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_allSB_btag_outputNRB_Data_ee_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_up_outputNRB_Data_ee_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_low_outputNRB_Data_ee_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_allSB_btag_outputNRB_Data_ee_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_allSB_btag_outputNRB_Data_ee_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_allSB_btag_outputNRB_Data_ee_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_allSB_btag_outputNRB_Data_ee_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_allSB_btag_outputNRB_Data_ee_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_allSB_btag_outputNRB_Data_ee_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_exp_allSB_bveto_outputNRB_Data_ee_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_allSB_bveto_outputNRB_Data_ee_METcut125']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_allSB_bveto_outputNRB_Data_ee_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_allSB_btag_outputNRB_Data_ee_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_allSB_btag_outputNRB_Data_ee_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_allSB_btag_outputNRB_Data_ee_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("\\hline $\\mu\\mu $  & $N_{e\\mu}^{in}$ & $N_{e\\mu}^{out}$  & $N_{\\mu\\mu}^{out}$&  $   \\alpha   $ & $N_{\\mu\\mu}^{SR, est}$& $N_{\\mu\\mu}^{SR, exp}$ & $f_{est/exp}$ \\\\   \n")
catalogfile.write("\\hline NRB & $"+"%.1f" %results_2D['Num_in_bveto_outputNRB_Data_emu_METcut125']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_up_outputNRB_Data_emu_METcut125'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_in_bveto_low_outputNRB_Data_emu_METcut125'])+"} $ & $ "+"%.1f" %results_2D['Num_allSB_btag_outputNRB_Data_emu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_up_outputNRB_Data_emu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_low_outputNRB_Data_emu_METcut80'])+"} $ & $  "+"%.1f" %results_2D['Num_allSB_btag_outputNRB_Data_mumu_METcut80']+"^{+"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_up_outputNRB_Data_mumu_METcut80'])+"}_{-"+"%.1f" %math.sqrt(results_2D['Errsquare_allSB_btag_low_outputNRB_Data_mumu_METcut80'])+"}$ & $"+"%.3f" %results_2D['alpha_allSB_btag_outputNRB_Data_mumu_METcut80']+"^{+"+"%.3f" %results_2D['Erralpha_high_allSB_btag_outputNRB_Data_mumu_METcut80']+"}_{-"+"%.3f" %results_2D['Erralpha_low_allSB_btag_outputNRB_Data_mumu_METcut80']+"}$ & $"+"%.1f" %results_2D['Num_pre_allSB_btag_outputNRB_Data_mumu_METcut80']+"^{+"+"%.1f" %results_2D['ErrNum_pre_high_allSB_btag_outputNRB_Data_mumu_METcut80']+"}_{-"+"%.1f" %results_2D['ErrNum_pre_low_allSB_btag_outputNRB_Data_mumu_METcut80']+"}$ & $ "+"%.1f" %results_2D['Num_exp_allSB_bveto_outputNRB_Data_mumu_METcut125']+"^{+"+"%.1f" %results_2D['ErrNum_exp_high_allSB_bveto_outputNRB_Data_mumu_METcut125']+"}_{-"+"%.1f" %results_2D['ErrNum_exp_low_allSB_bveto_outputNRB_Data_mumu_METcut125']+"}$ & $"+"%.2f" %results_2D['ratio_allSB_btag_outputNRB_Data_mumu_METcut80']+"^{+"+"%.2f" %results_2D['ratio_err_high_allSB_btag_outputNRB_Data_mumu_METcut80']+"}_{-"+"%.2f" %results_2D['ratio_err_low_allSB_btag_outputNRB_Data_mumu_METcut80']+"}$ \\\\ \\hline \n" )
catalogfile.write("\\end{tabular} \n")
