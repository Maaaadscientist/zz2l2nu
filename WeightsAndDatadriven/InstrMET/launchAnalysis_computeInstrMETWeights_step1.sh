...
#####################
#HZZanalysis
listDataset="WeightsAndDatadriven/InstrMET/listSamplesToRun_dataOnly.txt"
suffix="computeInstrMET_DiLeptonData"

#InstrMET
listDataset_InstrMET="WeightsAndDatadriven/InstrMET/listSamplesToRun_InstrMET_dataOnly.txt"
suffix_InstrMET="computeInstrMET_PhotonData_NoWeight"
