...
if __name__ == '__main__':
    ...
    if args.syst == 'weights' and args.analysis != 'DileptonTrees' and args.analysis != 'PhotonTrees':
        raise RuntimeError(
    ...
    if (args.analysis == 'DileptonTrees' or args.analysis == 'PhotonTrees') and args.syst in {'all', 'weights'}:
