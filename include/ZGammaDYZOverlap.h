#ifndef HZZ2L2NU_INCLUDE_ZGAMMADYZOVERLAP_H_
#define HZZ2L2NU_INCLUDE_ZGAMMADYZOVERLAP_H_
...
class ZGammaDYZOverlap final : public EventTrees {
 public:
  ZGammaDYZOverlap(Options const &options, Dataset &dataset);
...
#endif  // HZZ2L2NU_INCLUDE_ZGAMMADYZOVERLAP_H_
