...
int const ZGammaDYZOverlap::maxSize_;


ZGammaDYZOverlap::ZGammaDYZOverlap(Options const &options, Dataset &dataset)
...
po::options_description ZGammaDYZOverlap::OptionsDescription() {
...
bool ZGammaDYZOverlap::ProcessEvent() {
...
Photon const *ZGammaDYZOverlap::CheckPhotons() const {
  auto const &photons = photonBuilder_.Get();
...
std::optional<std::tuple<ZGammaDYZOverlap::LeptonCat, Lepton const *, Lepton const *>>
ZGammaDYZOverlap::CheckLeptons() const {
...
void ZGammaDYZOverlap::FillMoreVariables(std::vector<Jet> const &jets) {
  run_ = *srcRun_;
  lumi_ = *srcLumi_;
  event_ = *srcEvent_;
